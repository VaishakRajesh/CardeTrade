...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='django-insecure-change-me-in-production-use-env-variable')
...
INSTALLED_APPS = [
    ...
    # Local apps
    'accounts',                  # User accounts, auth, conversations, disputes
    'farmer',                    # Farm and batch management
...
MIDDLEWARE = [
    ...
    'accounts.middleware.AuditMiddleware',                   # Custom: Audit trail support
]
...
# AUTH URLS
# ============================================================
LOGIN_URL = '/accounts/login/'              # Redirect URL for login required
LOGIN_REDIRECT_URL = '/accounts/dashboard/' # Redirect after successful login
...
# ============================================================
# OpenRouter API key for the AI chatbot assistant.
# Get your key at https://openrouter.ai/keys
OPENROUTER_API_KEY = config('OPENROUTER_API_KEY', default='')

# Default model for the chatbot (free tier recommended for testing)
# Free options: google/gemma-2-9b-it, meta-llama/llama-3.2-3b-instruct
# Paid options: openai/gpt-4o-mini, anthropic/claude-3-haiku
OPENROUTER_MODEL = config('OPENROUTER_MODEL', default='google/gemma-2-9b-it')
